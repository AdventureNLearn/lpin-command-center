...
const APP_NAME = "Lily Pad Intelligence Network";
...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Lily Pad Intelligence Network — a board for honest questions. Governance, operations, and yields. You keep the call.",
      },
  ...
  component: () => (
    <html lang="en" className="dark antialiased" suppressHydrationWarning>
      ...
      <body className="bg-void text-fg overflow-hidden">
